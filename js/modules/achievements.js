...
import { saveToCloud, isUserLoggedIn } from './auth.js'; // <--- ИМПОРТ isUserLoggedIn
...
// ... (Класс Achievement без изменений) ...
class Achievement {
...
function renderHistoryList() {
    ...
    // === 1. БАННЕР ЛИМИТА (Если гость и лимит достигнут) ===
...
// ... (Остальные функции без изменений: unlockDirectAchievement, triggerAchievement, initAchievements, playSfx) ...
...
export function initAchievements() {
    ...
    window.addEventListener('achievements_updated', () => {
        renderHistoryList();
    });
